# -*- coding: utf-8 -*-
"""
This module provides functions to update and manage external service secrets in Vault.

Functions:
    update_vault_secrets(vault_ha_client: VaultHaClient, vault_config: VaultConfig) -> None:
        Update external service secrets in Vault.

    __create_update_external_services(client: hvac.Client, key: str, value: Dict) -> None:
